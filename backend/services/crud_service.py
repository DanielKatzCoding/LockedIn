...
class CRUDService:
    ...
    async def create_job_application(self, db: AsyncSession, job_application_data: JobApplicationStatus) -> JobApplication:
    ...
    async def update_job_application(self, db: AsyncSession, job_application_id: str, job_application_update: JobApplication) -> Optional[JobApplication]:
